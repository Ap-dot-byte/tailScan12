...
<div class="bg-wrap">
  ...
  <div class="cards">
    ...
    <div class="card card-orange">
      ...
      <a class="link-row" href="#" @click.prevent="irArticulos">
        <span class="link-left">
          ...
          Tiendas de artículos para perros/gatos
        </span>
        <svg class="chev" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M9 6l6 6-6 6"/></svg>
      </a>
      <a class="link-row" href="#">
    ...
    <div class="team-grid">
      ...
      <div class="team-card">
        ...
        <div class="photo-wrap">
          <img src="../assets/img/aida.png" alt="Aída López">
      ...
      <div class="team-card">
        <span class="badge-icon">✏️</span>
        <div class="photo-wrap">
          <img src="../assets/img/Natalia.png" alt="Natalia Martínez">
          <span class="paw-tag">🐾</span>
        </div>
        <h3>Natalia Martínez</h3>
        <div class="role">Community Manager</div>
        <div class="mini-divider"><span class="line"></span><span class="paw">🐾</span><span class="line"></span></div>
      </div>
